...
class AudioSRGanModel:
    ...
    def inference_loss(self, real, fake):
        ...
        # self.config.lambd is a parameter that we can set as our configuraion but 
    ...
    def train(self):
        ...
        for epoch in range(self.config.epoches):
            ...
            for idx in range(batch_idxs):
                ...
                end_time = time.time()
                print('epoch{}[{}/{}]:total_time:{:.4f},d_loss:{:.4f},g_loss:{:4f}'.format(epoch, idx, batch_idxs, end_time-start_time, d_loss, g_loss))
