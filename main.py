...
checkpointed_generator = './singlespeaker.lr0.000300.1.g4.b64/model.ckpt-53'
...
def main():
    ...
    with tf.Session() as sess:
        audiosrgan = AudioSRGanModel(FLAGS, checkpointed_generator, batch_size=1, H_R=8192, L_R = 2048, sess=sess)
